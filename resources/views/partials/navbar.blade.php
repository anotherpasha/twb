<header class="navbar__subpage">
    ...
    <nav class="navigation--home hard">
        <ul class="list__inline">
            ...
            <li class=""><a href="/profile" class="navigation--link black">Profilku</a></li>
            <li class="navigation--button"><a href="/submission" class="button button__primary button--small " data-target="login">Submit</a></li>
        </ul>
