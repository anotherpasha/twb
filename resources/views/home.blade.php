				...
				<div class="container">
						...
						<nav class="navigation--home hidden-on-small">
								...
								<ul class="list__inline">
                                    ...
                                    <li class=""><a href="{!! url('/winners') !!}" id="login-button" class="button button__secondary  button--small " data-target="login">Pemenang</a></li>
				...
				<div class="decoration__wrapper--main">
						...
						<div id="land" class="decoration--land--desktop">
								...
								<div id="flower-red-big"  class="decoration__character decoration--flower-red-big" >
					                ...
					                <div id="butterfly" class="decoration__character decoration--prizes">
